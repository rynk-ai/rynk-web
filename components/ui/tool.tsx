...
import { PiCheckCircle, PiCaretDown, PiSpinner, PiGear, PiXCircle } from "react-icons/pi"
      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <CollapsibleTrigger asChild>
          ...
          >
            ...
            <PiCaretDown className={cn("h-4 w-4", isOpen && "rotate-180")} />
          </Button>
        </CollapsibleTrigger>
        <CollapsibleContent
          className={cn(
