/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 6d6f08a7f38580e7f378dd50ce547bdb)
// Runtime types generated with workerd@1.20251210.0 2024-01-01 nodejs_compat_v2
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./custom-worker");
		durableNamespaces: "TaskProcessor";
	}
	interface Env {
		...
		POLAR_STANDARD_PRODUCT_ID: string;
		NEXT_PUBLIC_APP_URL: string;
		ALPHA_VANTAGE_API_KEY: string;
		GOOGLE_API_KEY: string;
		NEXT_PUBLIC_GOOGLE_APP_ID: string;
		RESEND_API_KEY: string;
		TASK_PROCESSOR: DurableObjectNamespace<import("./custom-worker").TaskProcessor>;
		BUCKET: R2Bucket;
